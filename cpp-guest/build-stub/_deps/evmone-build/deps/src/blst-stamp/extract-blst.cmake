...
#
get_filename_component(filename "/Users/jbaylina/git/zisk/zisk_eth_guest/cpp-guest/build-stub/_deps/evmone-build/deps/src/v0.3.15.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/jbaylina/git/zisk/zisk_eth_guest/cpp-guest/build-stub/_deps/evmone-build/deps/src/blst" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-blst${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-blst${i}")
