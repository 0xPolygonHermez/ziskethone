...
// stack[stackPointer + i], and depth == kStackLimit - stackPointer.
...
// 0x80 DUP1 — duplicate the 1st stack item onto the top.
...
// 0x81 DUP2 — duplicate the 2nd stack item onto the top.
...
// 0x82 DUP3 — duplicate the 3rd stack item onto the top.
...
// 0x83 DUP4 — duplicate the 4th stack item onto the top.
...
// 0x84 DUP5 — duplicate the 5th stack item onto the top.
...
// 0x85 DUP6 — duplicate the 6th stack item onto the top.
...
// 0x86 DUP7 — duplicate the 7th stack item onto the top.
...
// 0x87 DUP8 — duplicate the 8th stack item onto the top.
...
// 0x88 DUP9 — duplicate the 9th stack item onto the top.
...
// 0x89 DUP10 — duplicate the 10th stack item onto the top.
...
// 0x8a DUP11 — duplicate the 11th stack item onto the top.
...
// 0x8b DUP12 — duplicate the 12th stack item onto the top.
...
// 0x8c DUP13 — duplicate the 13th stack item onto the top.
...
// 0x8d DUP14 — duplicate the 14th stack item onto the top.
...
// 0x8e DUP15 — duplicate the 15th stack item onto the top.
...
// 0x8f DUP16 — duplicate the 16th stack item onto the top.
...
// 0x90 SWAP1 — swap the top with the 2nd stack item.
...
// 0x91 SWAP2 — swap the top with the 3rd stack item.
...
// 0x92 SWAP3 — swap the top with the 4th stack item.
...
// 0x93 SWAP4 — swap the top with the 5th stack item.
...
// 0x94 SWAP5 — swap the top with the 6th stack item.
...
// 0x95 SWAP6 — swap the top with the 7th stack item.
...
// 0x96 SWAP7 — swap the top with the 8th stack item.
...
// 0x97 SWAP8 — swap the top with the 9th stack item.
...
// 0x98 SWAP9 — swap the top with the 10th stack item.
...
// 0x99 SWAP10 — swap the top with the 11th stack item.
...
// 0x9a SWAP11 — swap the top with the 12th stack item.
...
// 0x9b SWAP12 — swap the top with the 13th stack item.
...
// 0x9c SWAP13 — swap the top with the 14th stack item.
...
// 0x9d SWAP14 — swap the top with the 15th stack item.
...
// 0x9e SWAP15 — swap the top with the 16th stack item.
...
// 0x9f SWAP16 — swap the top with the 17th stack item.
