...
#include "zeg/evmc2.h"          // backend-agnostic VM interface (prepare/execute2)
...
public:
    ...
    // Releases every cached pre-analysis handle and destroys the owned VM.
    ~ZiskStateDB();
...
private:
    ...
    void credit_block_reward()                noexcept;  // pre-Merge PoW reward
