...
// v9: compact StateRoot — a branch tags its 16 children in one word (a tagged
//     Empty child costs no bytes, a Hash child 32) and nibbles pack two per
//     byte. ~22% smaller witness.
